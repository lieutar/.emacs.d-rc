...
(defvar my:elsx:3cols:project nil)
(defun my:elsx:3cols:init-with-eshell (dir)
  (switch-to-buffer
...
(defun my:elsx:ws-vertically (size window op)
  (let* ((window (cond ((null    window) (selected-window))
                       ((windowp window) window)
                       ((symbolp window) 
                        (let ((wplist (elsx:get-window-plist-by-name window)))
...
(defun my:elsx:widen-vertically (size &optional window)
  (my:elsx:ws-vertically size window '<))

(defun my:elsx:shlink-vertically (size &optional window)
  (when nil
    (my:elsx:ws-vertically size window '>)))
 ...
 '((main
    ...
    ((|)
     ((- :size 84)
      ...
      (:name eshell
       :pop-to find-git
       :init (lambda () (my:elsx:3cols:init-with-eshell "~"))))
     ...
     ((|)
      ((- :size 85)
       (:name dired :size nil :init
              (lambda () (when my:elsx:3cols:project
                           (dired my:elsx:3cols:project))))
       (:name shell  :size nil :init
              (lambda () (when my:elsx:3cols:project
                           (my:elsx:3cols:init-with-eshell
                            my:elsx:3cols:project)))))
      ((-)
       ((| :size 50)
        (:name main-1
         :onfocus (lambda () (my:elsx:widen-vertically -10))
         :init (lambda () (when my:elsx:3cols:project
                            (dired my:elsx:3cols:project))))
       ...
       (:name info  :size nil :pop-to main-1
        :onfocus (lambda () (my:elsx:widen-vertically 40))
        :init (lambda () (when my:elsx:3cols:project
                           (dired my:elsx:3cols:project)))))
      );; end of composition
     );;end of project
   ...
   (default
     ...
     ((-)
      ((| :size 4)
       (:name slogan :size 85 :init (lambda () (ebadget:slogan)))
